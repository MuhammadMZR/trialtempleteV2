...
export default function Globe() {
  ...
  return (
    <section className="relative min-h-screen bg-[#051A3D] overflow-hidden py-32">
      {/* Background Video */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold tracking-widest text-white uppercase mb-6">
            Our Projects
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((item, index) => (
            <motion.div
              ...
              className="group relative bg-[#051A3D]/80 backdrop-blur-md border border-white/10 p-10 rounded-sm hover:border-gold/50 transition-colors duration-500 overflow-hidden"
            >
              ...
              <h3 className="text-2xl text-white font-bold tracking-wide mb-4">
                {item.title}
              </h3>
